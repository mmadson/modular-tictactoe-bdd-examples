...
public class InMemoryTicTacToeGame implements TicTacToeGame {
    ...
    public InMemoryTicTacToeGame(final Symbol playerSymbol, final TicTacToeAi ai) {
    ...
    public void mark(final Square squareToMark) {
        if (getGameState().isEnded()) {
            throw new RuntimeException("Game has already ended, unable to mark additional squares");
        }
